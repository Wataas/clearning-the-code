                ...
                while (jogando_mapa) {
                    ...
                    for (int i = 0; i < 12; i++) {
                        ...
                        for (int j = 0; j < 7; j++) {
                            ...
                            // Se for um alvo sozinho PINTA DE VERMELHO
                            else if (mapa[i][j] == '~') {
                    ...
                    // Próxima posição pretendida pelo jogador/no começo assume posição do jogador
                    int proximo_x = Lx;
                    int proximo_y = Ly;
                    ...
                    // SE A PRÓXIMA POSIÇÃO FOR VAZIA OU UM ALVO PODE ANDAR
                    ...
                    // SE A PRÓXIMA POSIÇÃO FOR UMA CAIXA EMPURRA
                    else if (mapa[proximo_x][proximo_y] == '@') {
                    // PARA ONDE A CAIXA VAI SER EMPURRADA
