...
//case +200- interaçoes do personagem
int main()
{
    bool faca=false;
    bool chave=false;
...
while(pagina!=0) {
        ...
        pausa();
            ...
            cout<<"Você se levanta e sente o frio do chão invisível, a sua frente um gato preto te olha com desdém, em sua esquerda há lenços de papel e a sua direita brilha suavemente a luz de um laptop velho, emitindo um fraco som de estática, junto do laptop há um caderno de desenhos com figuras que vc se recusa a visualizar. Olhando para cima uma lampâda preta paira pelo ar, de alguma forma ela mantém vc afastado da escuridão";
        pausa();
         ...
         case 200:   
            ...
            cout<<"1-examinar o gato preto"<< endl;
            cout<<"2-mexer no carpete" << endl;
            cout<<"3-checar lenços de papel" << endl;
            cout<<"4-olhar lâmpada preta" << endl;
            cin>>escolha;
            cin.ignore();
            if (escolha==1) {
                
                cout<<"vc se aproxima do gato"<< endl;
             pausa();
            
                cout<<"olhando de perto seu pelo é volumoso e macio, em seu pescoço há uma coleira"<< endl;
             pausa();
            
                cout<<"'meawo'-é oque está escrito"<< endl;
             pausa();    
                 pagina=200;
                 break;
            }
                ...
                cout<<"vc mexe no carpete, ele é liso e plano com um formato retangular"<< endl;
             pausa();
            
                cout<<"vc encontra uma 'bola de pelo'"<< endl;
             pausa();
                pagina=200;
                break;
            }
                ...
                cout<<"uma caixa de lenços para enxugar suas lágrimas"<< endl;
             pausa();
                
                cout<<"olhando mais vc percebe que no meio dos lenços, há umm bilhete escrito:"<< endl;
             pausa();
             
                cout<<"Não esqueça, o nome dela é a chave de suas memórias"<< endl;
             pausa();
                pagina=200;
                break;
            }
                ...
                cout << "Voce olha para cima. A lampada preta balança como um pendulo de um relogio parado." << endl;
             pausa();
             
                cout << "Ela emite uma 'luz negativa'. Ela nao ilumina o lugar, ela apenas define onde o nada termina." << endl;
             pausa();
             
                cout<<"enquanto a via balançar, de repente, um brilho metálico corta o vazio e uma faca cai do céu aterrisando perto de vc."<< endl;
              pausa();
              
                dc();
                cout<<"oque vc faz?"<< endl;
                cout<<"1-examinar faca (seguir)"<< endl;
                cout<<"2-continuar investigando seus arredores"<< endl;
                cin>>escolha;
                cin.ignore();
